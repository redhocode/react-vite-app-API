...
const Footer = () => {
  return (
    <>
    <footer className="w-full p-8 rounded-md bg-cyan-800">
  <div
    className="flex flex-row flex-wrap items-center justify-center text-center bg-cyan-800 gap-y-12 gap-x-12 ">
